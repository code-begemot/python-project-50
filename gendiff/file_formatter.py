    ...
    def iter_(current_value, path):
        ...
        for i in current_value.items():
            ...
            if current_path != '':
                ...
                deep_path = temp_key
            temp_value_before = '[complex value]' if isinstance(val, dict) else (val if val in ('true', 'false', 'null') else f"'{val}'")
            temp_value_after = '[complex value]' if isinstance(temp_val, dict) else (temp_val if temp_val in ('true', 'false', 'null') else f"'{temp_val}'")
